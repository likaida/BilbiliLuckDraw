...
import com.aceli.bilibililuckdraw.AppContext;
import com.aceli.bilibililuckdraw.AppContext;
...
public class Toasty {
    ...
    public static void show(@StringRes int message) {
        Application context = AppContext.INSTANCE.getMApplication();
        if (context != null) {
            normal(context, context.getString(message), Toast.LENGTH_SHORT, null, false).show();
        }
    }
    ...
    public static void show(@StringRes int message, Drawable icon) {
        Application context = AppContext.INSTANCE.getMApplication();
        if (context != null) {
            normal(context, context.getString(message), Toast.LENGTH_SHORT, icon, true).show();
        }
    }

    public static void show(@NonNull CharSequence message, Drawable icon) {
        Application context = AppContext.INSTANCE.getMApplication();
        if (context != null) {
    ...
    public static void show(@StringRes int message, int duration) {
        Application context = AppContext.INSTANCE.getMApplication();
        if (context != null) {
            normal(context, context.getString(message), duration, null, false).show();
        }
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                ToastyUtils.getColor(context, R.color.toast_warning_color), ToastyUtils.getColor(context, R.color.white),
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                ToastyUtils.getColor(context, R.color.toast_info_color), ToastyUtils.getColor(context, R.color.white),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                ToastyUtils.getColor(context, R.color.toast_success_color), ToastyUtils.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                ToastyUtils.getColor(context, R.color.toast_error_color), ToastyUtils.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ToastyUtils.getColor(context, R.color.toast_default_text_color),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ToastyUtils.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, iconRes),
                ToastyUtils.getColor(context, tintColorRes), ToastyUtils.getColor(context, R.color.toast_default_text_color),
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, ToastyUtils.getColor(context, tintColorRes),
                ToastyUtils.getColor(context, R.color.toast_default_text_color), duration, withIcon, shouldTint);
    }
...
//                return withLightTheme(context, message, icon, duration, withIcon);
    ...
    private static Toast withLightTheme(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                                        int duration, boolean withIcon) {
        return custom(context, message, icon, ToastyUtils.getColor(context, R.color.toast_default_text_color),
                ToastyUtils.getColor(context, R.color.toast_normal_color), duration, withIcon, true);
    }

    private static Toast withDarkTheme(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                                       int duration, boolean withIcon) {
        return custom(context, message, icon, ToastyUtils.getColor(context, R.color.toast_normal_color),
                ToastyUtils.getColor(context, R.color.toast_default_text_color), duration, withIcon, true);
    }
